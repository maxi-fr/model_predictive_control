...
def _(
    ...
    return cl, objective, u_max_val, u_min_val
...
@app.cell
def _(Dynamics, N, OCP, U_ref, X_ref, cl, dt, dynamics, objective):
    ocp = OCP(
        N=N,
        dt=dt,
        objective=objective,
    ...
    X_opt, U_opt, _status = ocp.solve(x0_val, X_guess=X_ref, U_guess=U_ref, x_ref=X_ref, u_ref=U_ref)
    return U_opt, X_opt
