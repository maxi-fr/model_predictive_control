...
def test_linear_raw_ocp_solve(benchmark) -> None:
    ...
    P, q, A_osqp, l_dyn, u_dyn, l_bnd, u_bnd, _A, _B, _N, nx, _nu = setup_raw_linearized_inverted_pendulum_mpc()
...
def test_linear_raw_mpc_step(benchmark) -> None:
    ...
    P, q, A_osqp, l_dyn, u_dyn, l_bnd, u_bnd, A, B, _N, nx, nu = setup_raw_linearized_inverted_pendulum_mpc()
